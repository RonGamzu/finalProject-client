...
export default function AddMovie({ getMoviesData, genres, connected, handleSignUp }) {
  const initialValues = {
    movieName: "",
    coverUrl: "",
    synopsis: "",
  ...
  const validationSchema = Yup.object({
    movieName: Yup.string().max(50, "Max characters is 50")
    .required("Required"),
    ...
    genres: Yup.array().required('genre is required').min(1, 'Please pick at least 1 genre')
  });
...
console.log('connected', connected);
  ...
  return (
    ...
    <Form className="mt-4"  onSubmit={formik.handleSubmit}>
      <h2 className="text-center" style={{ color: "orange" }}>Add new movie</h2>
